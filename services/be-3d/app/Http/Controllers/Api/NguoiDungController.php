...
class NguoiDungController extends Controller
{
    ...
    public function getProfile()
    {
        ...
        $tongChiTieu = (float) ($user->tong_chi_tieu ?? 0.0);
        $diemThanhVien = (int) ($user->diem_thanh_vien ?? 0);
        $diemChoDuyet = (int) ($user->diem_cho_duyet ?? 0);
        $hangThanhVien = $user->hang_thanh_vien ?? 'dong';
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'diem_thanh_vien' => $diemThanhVien,
                'diem_cho_duyet' => $diemChoDuyet,
                'hang_thanh_vien' => $hangThanhVien,
    ...
    public function cancelOrder(Request $request, $id)
    {
        ...
        try {
            // Lock user để tránh race condition
            ...
            // Hoàn lại voucher nếu có khi hủy đơn
            if ($order->id_ma_giam_gia) {
                $voucher = \App\Models\MaGiamGia::find($order->id_ma_giam_gia);
                if ($voucher) {
