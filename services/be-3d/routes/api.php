...
Route::middleware('throttle:api')->group(function () {
    ...
    Route::get('/ma-giam-gia/claimable', [KhuyenMaiController::class, 'getClaimableVouchers']);
    ...
    Route::get('/chatbot/order-status/{code}', [ChatbotController::class, 'getOrderStatusByCode']);
...
Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    ...
    Route::middleware('role:quan_ly,quan_tri')->prefix('quan-ly')->group(function () {
        ...
        Route::patch('/don-hang/{id}/thanh-toan', [ManagerController::class, 'updatePaymentStatus']);
        ...
        Route::post('/khuyen-mai/coupon/distribute', [KhuyenMaiController::class, 'distributeVoucher']);
...
Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    ...
    Route::prefix('khach-hang')->group(function () {
        ...
        Route::get('/ma-giam-gia/my-vouchers', [KhuyenMaiController::class, 'getMyVouchers']);
        Route::post('/ma-giam-gia/claim/{code}', [KhuyenMaiController::class, 'claimVoucher']);
